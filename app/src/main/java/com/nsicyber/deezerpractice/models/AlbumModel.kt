...
class AlbumModel:Serializable {
    ...
    @SerializedName("genre_id"                ) var genreId               : Int?                    = null
    @SerializedName("genres"                  ) var genres                : ArrayGenreModel?                 = ArrayGenreModel()
    @SerializedName("label"                   ) var label                 : String?                 = null
    @SerializedName("nb_tracks"               ) var nbTracks              : Int?                    = null
    ...
    @SerializedName("contributors"            ) var contributors          : ArrayList<ArtistModel> = arrayListOf()
    @SerializedName("artist"                  ) var artist                : ArtistModel?                 = ArtistModel()
    @SerializedName("type"                    ) var type                  : String?                 = null
    @SerializedName("tracks"                  ) var tracks                : MusicModel?                 = MusicModel()

}

class ArrayAlbumModel:Serializable {
    @SerializedName("data" ) var data : ArrayList<AlbumModel> = arrayListOf()
}
